...
var smallBtn = document.querySelector(".js-small");
var middleBtn = document.querySelector(".js-middle");
var largeBtn = document.querySelector(".js-large");
var labelSize = document.querySelectorAll(".form-label");
var inputSize = document.querySelectorAll(".custom-col");
...
function fontSize(x) {
  labelSize.forEach(function (item) {
    item.style.fontSize = x + "px";
  });
}

function formSize(y) {
  inputSize.forEach(function (item) {
